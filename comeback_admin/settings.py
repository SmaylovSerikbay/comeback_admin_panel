"""
Django settings for comeback_admin project.
"""
...
# CSRF settings
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='https://admin.comeback.uz,http://89.39.95.247', cast=lambda v: [s.strip() for s in v.split(',')])
...
ROOT_URLCONF = 'comeback_admin.urls'
...
WSGI_APPLICATION = 'comeback_admin.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('POSTGRES_DB', default='comeback_admin'),
        'USER': config('POSTGRES_USER', default='comeback_user'),
        'PASSWORD': config('POSTGRES_PASSWORD', default='comeback_password_2025'),
...
FIREBASE_CONFIG = {
    ...
    'project_id': config('FIREBASE_PROJECT_ID', default='comeback-2a6b2'),
...
FIREBASE_DATABASE_URL = config('FIREBASE_DATABASE_URL', default='https://comeback-2a6b2-default-rtdb.firebaseio.com/')
FIREBASE_STORAGE_BUCKET = config('FIREBASE_STORAGE_BUCKET', default='comeback-2a6b2.firebasestorage.app')
