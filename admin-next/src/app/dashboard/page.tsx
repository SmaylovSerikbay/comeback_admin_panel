...
export default function DashboardPage() {
  ...
  return (
    <div>
      <h1 className="mb-8 text-2xl font-bold text-slate-800">Дашборд</h1>
      {firebase_status !== "connected" && (
        <div className="mb-6 rounded-lg border border-amber-200 bg-amber-50 px-4 py-2 text-amber-800">
      ...
      <div className="mb-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {cards.map((c) => (
          <div key={c.label} className="card">
            ...
            <p className="mt-1 text-2xl font-bold text-slate-900">{c.payments}</p>
      ...
      <div className="card">
        <h2 className="mb-4 text-lg font-semibold">Последние платежи</h2>
